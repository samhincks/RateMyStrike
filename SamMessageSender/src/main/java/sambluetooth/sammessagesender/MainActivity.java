...
/** This is basically what we're aiming at; we're going to start
 */
...
public class MainActivity extends Activity {
    ...
    private void sendCommand(Intent action) throws RemoteException {
        ...
        Message msg = Message.obtain(null, 1003, action);
        Bundle b  = new Bundle();
        b.putString("data", "fakevalue");
        msg.setData(b);

        ///.. AND HERE WE ARE. WHATEVER IS PUT IN SET ACTION WILL BE SENT!!!
        action.setAction("fakevalue2");
        ...
        ad.y =2;
        ad.z =3;
        mService.send(Message.obtain(null, 1337, ad));*/
    }
